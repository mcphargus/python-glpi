...
__author__ = "clint.grimsley@gmail.com"
...
class GLPIClient:
    ...
    def add_ticket_document(self, ticket, url=None, name=None,
        ...
        L{GLPIClient.add_ticket_followup}
        @param _help: get usage information
        """
...
class GLPIUser(GLPIObject):
    """ User, Inherits GLPIObject """
    firstname = None
    realname = None
    email = None
    phone = None
...
class GLPITicket(GLPIObject):
    """ Ticket, inherits L{GLPI.GLPIObject} """
    entities_id = None
    name = None
    date = None
    closedate = None
...
class GLPIInventoryItem(GLPIObject):
    """ InventoryItem, inherits L{GLPI.GLPIObject} """
...
class GLPIComputer(GLPIInventoryItem):
    """ Computer, inherits L{GLPI.GLPIInventoryItem} """
    def __init__(self):
        """
        TODO: Needs to be implemented
        """
...
class GLPIDocument(GLPIObject):
    """ Document, inherits L{GLPI.GLPIObject} """
    def __init__(self):
        """
        TODO: Needs to be implemented
        """
